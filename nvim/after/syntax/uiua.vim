...
syn keyword uiuaMonadicMod gap dip on by eac[h] row[s] tab[le] inv[entory] rep[eat] fol[d] reduce scan gro[up] par[tition] un bot[h] con[tent] memo quote comptime stringify spawn pool tri[angle] bel[ow] bac[kward] abo[ve]
syn match   uiuaMonadicMod '[⋅⊙⟜⊸∵≡⊞⍚⍥∧/\\⊕⊜°∩◇λ◹◡¨◠]'

" non-monadic modifiers
syn keyword uiuaOtherMod do und[er] fil[l] bra[cket] for[k] try setinv setund swi[tch]
